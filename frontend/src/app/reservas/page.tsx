...
export default function ReservasPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col font-sans selection:bg-indigo-100 h-screen overflow-hidden">
            {/* Header */}
            <header className="h-20 flex items-center justify-between px-8 bg-white/80 backdrop-blur-xl border-b border-slate-200/60 shrink-0 z-10">
                ...
                <div className="flex items-center gap-6">
                    <nav className="hidden lg:flex items-center gap-1 bg-slate-100/80 p-1.5 rounded-2xl">
                        ...
                        <span className="px-5 py-2 text-sm font-bold rounded-xl transition-all duration-300 bg-white text-indigo-900 shadow-sm cursor-default">
                            Reservas
                        </span>
                    </nav>
